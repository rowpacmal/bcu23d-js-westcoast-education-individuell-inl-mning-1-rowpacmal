...
import { createContactUs } from '../components/contact.js';
...
export const createDOM = {
  ...
  layout: (parent, type) => {
    switch (type) {
      ...
      case 'about':
        parent.appendChild(createAboutUs());
        break;

      case 'contact':
        parent.appendChild(createContactUs());
        break;
      ...
      case 'user-profile':
        parent.appendChild(createUserProfile());
        break;
